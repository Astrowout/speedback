...
const AppCommentDetail: NextPage = ({ project, comment }: InferGetStaticPropsType<typeof getStaticProps>) => {
	...
	return (
		<AppLayout>
			...
			<main>
				<Heading title={project?.name || "Your project"} backLink={{ url: `/app/projects/${project.id}`, label: "Back to projects" }}>
					<div className="-my-1.5 -mx-2 mt-5 flex flex-wrap lg:mt-0">
						...
						<Link
							href={`/app/projects/${project.id}/comments/${comment.id}/edit`}
						>
