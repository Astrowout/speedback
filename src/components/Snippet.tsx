...
const Snippet: FunctionComponent<SnippetProps> = ({ children, className, id }) => {
	return (
		<div className={cn(className, "rounded border-2 p-6")}>
			...
			<div className="relative mt-4 max-w-full">
				<pre className="p-6 pr-32 overflow-auto max-w-full bg-gray-900 rounded text-gray-100">
					<code className="text-sm">
						{`<script src="http://127.0.0.1:5500/index.js?id=${id}" type="module" crossorigin charset="utf-8"></script>`}
					</code>
				</pre>

				<button className="flex bg-white text-gray-600 items-center absolute right-3 top-3 rounded px-3 py-2">
