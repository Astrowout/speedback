...
function Oa(t, e, n) {
  ...
  const c = async ({ clientX: m, clientY: v }) => {
    ...
    !r || v || (c(m), i || (n(2, a.style.display = "", a), n(3, i = !0)));
  }, f = () => {
