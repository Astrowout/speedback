...
{#if $commentModeActive}
	<div
		class="spd-absolute spd-transition !spd-cursor-auto spd-top-0 spd-left-0 spd-flex spd-items-start spd-delay-100 spd-duration-300 spd-ease-out spd-space-x-2 spd-z-[999999]"
	...
	>
		...
		<form
			class="spd-flex spd-flex-col spd-w-full spd-max-w-xs spd-shadow-lg spd-border spd-border-zinc-600 spd-bg-black spd-rounded-md spd-text-white"
